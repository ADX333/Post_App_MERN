  ...
  return (
    <div className="bg-[#1c1c1c] h-screen text-amber-100 border-2 flex flex-col border-amber-300 font-serif">
      ...
      <form className='flex flex-col'>
        ...
        <input className="bg-gray-700 border-2 border-amber-300 hover:scale-103 transition-all duration-300 rounded w-100 mb-2" type="text" name="caption" required placeholder='Caption'/>
